...
urlpatterns = [
    ...
    #OBTENER CONSUMO DEL MES DE UN EQUIPO
    path('<str:nro_serie>/consumo-mensual/<str:mes>', views.ConsumoMensualEquipoView.as_view(), name='registros_equipo_consumo_anual'),
    #OBTENER EL CONSUMO DIARIO DE UN EQUIPO 
    path('<str:nro_serie>/consumo-diario/<str:fecha>', views.ConsumoDiarioEquipoView.as_view(), name='registros_equipo_consumo_anual'),

    #LISTAR CONSUMOS EN EL MES POR DIA DE UN EQUIPO 
    # fecha: "<n° mes>-<año>"
    path('<str:nro_serie>/consumo-mensual-dia/<str:fecha>', views.ConsumoMensualPorDiaEquipoView.as_view(), name='registros_equipo_consumo_mensual'),
    #Lista el consumo diario de un equipo en una fecha. fecha: "<n° dia>-<n° mes>-<año>"
